...
public class HistoryProviderHelper  {
	...
	public void insertMove(long gameId, Cell cell) {
		...
		values.put(HistoryContract.GameColumns.COLUMN_NAME_X, cell.x);
		values.put(HistoryContract.GameColumns.COLUMN_NAME_Y, cell.y);
		values.put(HistoryContract.GameColumns.COLUMN_NAME_REL, gameId);
		values.put(HistoryContract.GameColumns.COLUMN_NAME_KIND, cell.contents);
	...
	public long insertGame() {
		...
		values.put(HistoryContract.HistoryColumns.COLUMN_NAME_TIME, String.valueOf(timeMilliseconds));
		values.put(HistoryContract.HistoryColumns.COLUMN_NAME_SCORE1, 0);
		values.put(HistoryContract.HistoryColumns.COLUMN_NAME_SCORE2, 0);
		values.put(HistoryContract.HistoryColumns.COLUMN_NAME_NUMBEROFMOVES, 0);
	...
	public int updateScores(long gameId, int scoresBalck, int scoresWhite, int numMoves) {
		ContentValues values = new ContentValues();
		values.put(HistoryContract.HistoryColumns.COLUMN_NAME_SCORE1, scoresBalck);
		values.put(HistoryContract.HistoryColumns.COLUMN_NAME_SCORE2, scoresWhite);
		values.put(HistoryContract.HistoryColumns.COLUMN_NAME_NUMBEROFMOVES, numMoves);
